...
export function HostShell({
  ...
  return (
    <div
      className={`${lazydog.variable} ${petitCochon.variable} ${lazydog.className} stonefruit-root stonefruit-root--ops flex flex-col`}
    >
      <StonefruitSkyFit />
      <div className="sf-stage">
        ...
        <main
          className={`relative z-10 mx-auto flex w-full max-w-3xl flex-1 flex-col px-5 pt-6 pb-8 ${
